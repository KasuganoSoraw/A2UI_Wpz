...
class AddRegionTextDelta(BaseModel):
    ...
    region_id: str
    text: str
    usage_hint: Literal["h1", "h2", "h3", "body", "caption", "warning", "code_echo"] = (
        "body"
    )
...
class AddRegionListItemDelta(BaseModel):
    ...
    title_usage_hint: Literal["h1", "h2", "h3", "body", "caption", "warning"] | None = (
        None
    )
    detail_usage_hint: (
        Literal["h1", "h2", "h3", "body", "caption", "warning"] | None
    ) = None
